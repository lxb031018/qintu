...
class ReceiverMapWidget extends StatefulWidget {
  /// 地图创建成功回调
  ...
  @override
  State<ReceiverMapWidget> createState() => _ReceiverMapWidgetState();
}

class _ReceiverMapWidgetState extends State<ReceiverMapWidget> {
