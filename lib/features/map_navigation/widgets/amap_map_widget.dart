...
///
/// 架构说明：
/// - [AmapMapWidget] - 纯 UI 组件，位于 widgets 层
/// - [AmapMapController] - 平台 API 封装，位于 core 层
/// ============================================

class AmapMapWidget extends StatefulWidget {
  ...
  @override
  State<AmapMapWidget> createState() => _AmapMapWidgetState();
}

class _AmapMapWidgetState extends State<AmapMapWidget> {
