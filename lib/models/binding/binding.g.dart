...
Binding _$BindingFromJson(Map<String, dynamic> json) => Binding(
  ...
  partnerOpenid: json['partner_user_ID'] as String?,
  ...
  senderOpenid: json['sender_user_ID'] as String?,
