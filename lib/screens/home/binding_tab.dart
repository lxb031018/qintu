...
/// 绑定管理 Tab
class BindingTab extends StatefulWidget {
  const BindingTab({super.key});

  @override
  State<BindingTab> createState() => _BindingTabState();
}

class _BindingTabState extends State<BindingTab> {
